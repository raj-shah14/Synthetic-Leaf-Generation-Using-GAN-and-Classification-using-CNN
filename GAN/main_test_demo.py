...
parser.add_argument('--phase', dest='phase', default='train', help='train, test, run_all')
...
parser.add_argument('--visual_dir', dest='visual_dir', default='./visual_dir', help='visual samples are saved here')
...
def main(_):
    ...
    with tf.Session() as sess:
        model = pix2pix(sess, image_size=args.fine_size, batch_size=args.batch_size,
                        ...
                        checkpoint_dir=args.checkpoint_dir, sample_dir=args.sample_dir,visual_dir = args.visual_dir)
        ...
        elif args.phase == 'test_demo':
            model.test_demo(args)
        else: # run all
            model.train(args)
            model.test_new_temp(args)
